...
;; - it is your responsibility to ensure your expressions are safe to evaluate, non-redundant and correct in the context of the problem
(
 ...
 ("Farmer and wolf and cabbage are one side, goat is on the other side"
